...
namespace Consepts
{
    internal class Collections
    {
        internal void ArrayRun()
        {
            ...
            // Ein Array hat immer eine feste Größe, welche bei der Initialisierung fesgelegt werden muss
            ...
            /*
             For Loop - 4 Komponenten
                ...
                3. Operation, welche nach jeder Iteration ausgeführt wird -> idr. Inkrement (i++) oder Dekrement (i--)
                4. Codeblock, welcher definiert, was bei jeder iteration der Schleife passieren sol.
             */
            ...
            // Variablen, welche innerhalb eines Blocks deklariert sind, können nicht außerhalb dieses Blocks verwendet werden.

            {
                // Console.WriteLine(test_me);
               // int my_cool_variale = 0;
                {
